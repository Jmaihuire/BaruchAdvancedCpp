...
// 6.1.2 Part D: 
// this is calling the distance method form point
// but in Line class will show up as length() 
double Line::length() { return p1_->Distance(*p2_); } // this is calling the distance method form point
